...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   bmp[0] = LoadImage(NULL, L"lol1.bmp", IMAGE_BITMAP, 32, 32, LR_LOADFROMFILE);
   bmp[1] = LoadImage(NULL, L"lol2.bmp", IMAGE_BITMAP, 32, 32, LR_LOADFROMFILE);
   bmp[2] = LoadImage(NULL, L"lol3.bmp", IMAGE_BITMAP, 32, 32, LR_LOADFROMFILE);
   bmp[3] = LoadImage(NULL, L"lol4.bmp", IMAGE_BITMAP, 32, 32, LR_LOADFROMFILE);
